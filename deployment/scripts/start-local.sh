...
log ""
log "Single-Domain Architecture:"
log "  All services are accessible through http://localhost:3000"
log ""
log "Service Endpoints:"
log "  - Main Website:  http://localhost:3000"
log "  - Admin Panel:   http://localhost:3000/admin"
log "  - Scholar Forge: http://localhost:3000/scholars"
log "  - Admin API:     http://localhost:3000/api (proxied to port 8000)"
log "  - Scholars API:  http://localhost:8081 (direct access)"
log ""
log "Direct Service Ports (for debugging):"
log "  - Frontend:      3000"
log "  - Admin Backend: 8000"
log "  - Scholars API:  8081"
log "  - Scholar Forge: 4500"
log ""
log "Logs:"
